...
npm ls --include prod --include dev  | tee npm_ls_root.txt
echo "Install dependencies on client folder"
cd client
npm install --include prod --include dev
npm ls --include prod --include dev | tee npm_ls_client.txt
echo "Lint client"
npm run lint
echo "Build client"
npm run build
...
cd ../server
npm install --include prod --include dev
npm ls --include prod --include dev | tee npm_ls_server.txt
echo "Lint server"
npm run lint
echo "Build server"
